...
\section{Experiências}
	\subsection{Profissionais}
		\cventry{2014 -- atual}{Consultor de Tecnologia}{Accenture do Brasil}{São Paulo/SP}{}{Consultor em projetos de implantação de tecnologias como SAP, Oracle e sistemas customizados nas indústrias de Serviços e Bens de Consumo e para o Varejo. Minhas principais responsabilidades e características de trabalho são:%
			\begin{itemize}
				\item interface com clientes nacionais e multinacionais nas fases de levantamento e amadurecimento de requisitos;
                \item líder de uma de várias equipes (responsável pelo desenho e implantação de e-commerce) de um projeto de tecnologia para grande varejista atuando no Brasil;
				\item gestão de prazos de projeto e conciliação de capacidades de entrega de múltiplos fornecedores;
...
\cvitemwithcomment{Gerência de Projetos}{treinamentos internos}{Metodologias Ágeis e Tradicionais}
