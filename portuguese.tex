...
\extrainfo{%
		skype: luizfelipeasoares, solteiro, 28 anos.}					% informação opcional, caso não a queria, elimine a linha
...
\cvitemwithcomment{Alemão}{nível B1}{Certificado pela Universität Stuttgart}
...
\cvitemwithcomment{Linguagens de Programação}{experiência de trabalho}{C, Java, Bash e Python}
...
\cvitem{Métodos de Organização Pessoal}{Utilizador já há dois anos do método GTD (\emph{Getting Things Done}}
