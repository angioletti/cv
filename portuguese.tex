...
\address{Rua Oswaldo Cruz, 195 ap 54}{Valinhos, SP - 13276-230}
...
\extrainfo{%
		solteiro, 28 anos, skype: luizfelipeasoares}					% informação opcional, caso não a queria, elimine a linha
...
\cvitemwithcomment{Pacote MS-Office}{conhecimentos avançados}{Word e Excel}
\cvitemwithcomment{Pacote MS-Office}{conhecimentos básicos}{PowerPoint e Access}
...
\cvitemwithcomment{Linguagens de Programação}{conhecimentos avançados}{Bash, Python, LaTeX}
...
\section{Interesses}
\cvitem{Literatura Clássica}{Leitura em andamento: Os Miseráveis (Victor Hugo); última obra lida: Crime e Castigo (Fiódor Dostoiévski)}
\cvitem{Métodos de Organização Pessoal}{Utilizador já há seis anos do método GTD (\emph{Getting Things Done)}}
...
\cvitem{Viagens}{as mais recentes foram a Brotas/SP (fev/2013) e a Alter-do-Chão/PA (out/2013)}
